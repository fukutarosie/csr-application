...
export default function LoginPage() {
  ...
  // Available roles
  const roles = [
    { name: 'User Admin', value: 'User Admin' },
    { name: 'PIN', value: 'PIN' },
    { name: 'CSR Rep', value: 'CSR Rep' },
    { name: 'Platform Management', value: 'Platform Management' }
  ];
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="pl-10 mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150"
          ...
          <div className="mt-6">
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 transition duration-150"
            >
              {loading ? (
                <>
